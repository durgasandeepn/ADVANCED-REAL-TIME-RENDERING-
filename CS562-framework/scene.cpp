...
//  L_ViewMatrix = LookAt(lightPos, lightDir, upDir);
    ...
    L_ProjectionMatrix = Perspective(Rx, Ry, front, back);//back -> 5000
...
void Scene::DrawScene()
{
    ...
    CHECKERROR;
    int loc, programId, ShadowPrgId, GBufferPrgId, HorzPrjId, VerticalPrjId;
    ////////////////////////////////////////////////////////////////////////////////
   ...
   ////////////////////////////////////////////////////////////////////////////////
    ...
    HorizCS->DispatchComputerShader(1024, 1024, 1, 1024);
    ...
    */
    ...
    VerticalCS->DispatchComputerShader(1024, 1024, 1, 1024);
